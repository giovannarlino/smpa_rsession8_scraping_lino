...
# we need to inspect the website tables to understand better the code and the classes of tables 
...
```{r}
html_nodes(webpage,"table") #another option rather than html_table 
```
...
```{r}
html_nodes(webpage,"[class='table table-bordered table-striped']")[[2]] #look for specific tables and classes 
```
